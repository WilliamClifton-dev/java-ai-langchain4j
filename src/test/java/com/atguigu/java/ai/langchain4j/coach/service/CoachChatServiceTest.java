...
class CoachChatServiceTest {
    ...
    void injectsCurrentDateAndSelectedScenePromptIntoTheAgent() {
        ...
        CoachChatService service = new CoachChatService(
                ...
                new CoachModelAccess(new CoachRateGuard(new InMemoryEphemeralStateStore(clock),
                        20, Duration.ofMinutes(1)), new ModelCircuitBreaker(3, Duration.ofSeconds(30), clock), 5));
